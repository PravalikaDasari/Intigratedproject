...
public class TimeSheeApprovalDto {
	...
	public TimeSheeApprovalDto(Timestamp weekStartDate,String email,Timestamp plannedStartDate,Timestamp plannedEndDate,Timestamp weekEndDate, String projectName, String accountName,
			String empCode, String designation, int managerId, String timesheetStatus, String fullName, Long billingHours,
